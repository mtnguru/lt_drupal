...
function olive_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $form['#validate'][] = 'olive_theme_settings_validate';
  $form['#attached']['library'][] = 'olive/color-picker';
  ...
  $form['#attached']['drupalSettings']['olive']['colorSchemes'] = $color_config['schemes'];
  ...
  $form['olive_settings']['olive_utilities']['olive_color_scheme'] = [
    '#type' => 'fieldset',
    '#title' => t('Olivero Color Scheme Settings'),
  ];
  $form['olive_settings']['olive_utilities']['olive_color_scheme']['description'] = [
    '#type' => 'html_tag',
    '#tag' => 'p',
  ...
  $form['olive_settings']['olive_utilities']['olive_color_scheme']['color_scheme'] = [
    '#type' => 'select',
  ...
  foreach ($color_config['colors'] as $key => $title) {
    $form['olive_settings']['olive_utilities']['olive_color_scheme'][$key] = [
      '#type' => 'textfield',
      '#maxlength' => 7,
      '#size' => 10,
      '#title' => t($title),
      ...
      '#wrapper_attributes' => [
        'data-drupal-selector' => 'olive-color-picker',
      ],
    ];
  }
}
 ...
 */
function olive_theme_settings_validate($form, FormStateInterface $form_state) {
